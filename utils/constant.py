...
parser.add_argument('--window-stride', default=.02, type=float, help='Window stride for spectrogram in seconds')
...
parser.add_argument('--max-norm', default=100, type=float, help="max norm for clipping")
